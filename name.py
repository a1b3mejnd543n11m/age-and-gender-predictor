...
while cv2.waitKey(1)<0:
    ...
    for facebox in faceboxes:
        face=face=frame[max(0,facebox[1]-padding):
        ...
        print(f'age:{age[1:-1]}age year')    
        cv2.putText(resultimg,f'{gender},{age}',(facebox[0],facebox[1]-10),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2,cv2.LINE_AA)
        cv2.imshow('ageandgender',resultimg)